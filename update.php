    ...
    <div class="container">
        ...
        <div class="right">
            ...
            <form method="POST" action="">
                ...
                <label class="minititle">Username</label><input type="text" name="Username" value="<?php echo $rows['Username']; ?>" <?php if ($rows['Status'] != 3) echo 'readonly'; ?> /><br /><br />
                <label class="minititle" <?php if ($rows['Status'] != 3) echo 'hidden'; ?>>Password</label><input type="password" id="myInput" name="Password" <?php if ($rows['Status'] != 3) echo 'hidden'; ?> value="<?php echo $rows['Password']; ?>" required /><input <?php if ($rows['Status'] != 3) echo 'hidden'; ?> type="checkbox" onclick="showPwd()" name="" id="">
                <div <?php if ($rows['Status'] != 3) echo 'hidden'; ?>>Hiện mật khẩu</div>
                <?php if ($rows['Status'] != 1) echo '<br><br>'; ?>
                <label class="minititle">Email</label><input type="text" name="Email" value="<?php echo $rows['Email']; ?>" required <?php if ($rows['Status'] != 3) echo 'readonly'; ?> /><br /><br />
                <label class="minititle" <?php if ($rows['Status'] == 1) echo 'hidden'; ?>>Trạng thái</label>
                ...
                <?php if ($rows['Status'] != 1) echo '<br><br>'; ?>
                <label class="minititle">Họ tên</label>
                <input type="text" name="Fullname" value="<?php echo $rows['Fullname']; ?>" required /><br /><br />
                <label class="minititle">Ngày Sinh</label>
                <input type="date" name="Birthday" value="<?php echo $rows['Birthday']; ?>" required /><br /><br />
