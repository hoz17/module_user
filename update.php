...
<div class="div_center">
    ...
    <form method="POST" action="">
        ...
        <?php if ($row4['Status'] != 1) echo '<br><br>'; ?>
        <p class="minititle">Email</p><input type="text" name="Email" value="<?php echo $rows['Email']; ?>" required /><br /><br />
        <p class="minititle" <?php if ($row4['Status'] == 1) echo 'hidden'; ?>>Trạng thái</p>
        <select name="cboStatus" id="cboStatus" <?php if ($row4['Status'] == 1) echo 'hidden'; ?>>
